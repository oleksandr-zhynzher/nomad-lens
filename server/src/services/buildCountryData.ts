import type { CountryData, CategoryScore, ClimateData, RestCountry, WorldBankIndicatorMap } from '../utils/types';
import { WB_INDICATORS } from '../services/worldBank';
...
export interface BuildCountryDataInput {
  countries: RestCountry[];
  wbData: WorldBankIndicatorMap;
  whoData: Map<string, number>;
  climateMap: Map<string, ClimateData>;
}
...
export function buildCountryData({
  ...
  whoData,
  climateMap,
}: BuildCountryDataInput): CountryData[] {
