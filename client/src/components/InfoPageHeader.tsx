...
export function InfoPageHeader({ activePage }: InfoPageHeaderProps) {
  ...
  return (
    ...
    >
      ...
      {/* Mobile dropdown */}
      {mobileMenuOpen && (
        <div className="md:hidden flex flex-col gap-1 px-4 pb-3" style={{ backgroundColor: "#0D0E10", borderTop: "1px solid #1C1C1C" }}>
          <Link
            to="/indicators"
            onClick={() => setMobileMenuOpen(false)}
            className="py-2.5"
            style={{ fontFamily: "Geist, sans-serif", fontSize: "14px", fontWeight: activePage === "indicators" ? 600 : "normal", color: activePage === "indicators" ? "#C2956A" : "#999999", textDecoration: "none" }}
          >
            Indicators
          </Link>
          <Link
            ...
            onClick={() => setMobileMenuOpen(false)}
            className="py-2.5"
            style={{ fontFamily: "Geist, sans-serif", fontSize: "14px", fontWeight: activePage === "data-sources" ? 600 : "normal", color: activePage === "data-sources" ? "#C2956A" : "#999999", textDecoration: "none" }}
          >
            Data Sources
          </Link>
          <a
